...
class Section:
	...
	def setSection(self, section):
		self.minx = section.minx
		self.maxx = section.maxx
		self.minz = section.minz
		self.maxz = section.maxz
		self.miny = section.miny
		self.maxy = section.maxy
...
def getSections(box, maxHeight):
	...
	while(currentSection.maxy <= maxHeight and currentSection.maxx - currentSection.minx >= 3 and currentSection.maxz - currentSection.minz >= 3):
...
def generateCeilings(level, section):
	...
	fillSection(level, (43, 5), section)
